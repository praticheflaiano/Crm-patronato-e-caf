          ...
          <div className="flex min-h-screen overflow-hidden bg-slate-100">
            <aside className="flex w-72 shrink-0 flex-col border-r border-slate-200 bg-white">
              <div className="flex h-20 items-center gap-3 border-b border-slate-200 px-6">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-slate-500">CRM CAF e Patronato</p>
                </div>
              </div>
              ...
              <div className="border-t border-slate-200 p-4">
                <div className="mb-3 truncate text-sm font-medium text-slate-600" title={user.email || ''}>{user.email}</div>
                <form action={logout}>
            ...
            <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
              <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-white px-8">
                <div>
                  <h2 className="text-sm font-semibold uppercase tracking-wide text-slate-500">CRM System</h2>
