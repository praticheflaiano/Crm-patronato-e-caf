        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-1">
              ...
              <strong> Titolo</strong>, <strong>Tipo</strong>, <strong>Stato</strong> e <strong>Codice Fiscale</strong> (tutte obbligatorie).
              Il Codice Fiscale è necessario per associare correttamente la pratica a un contatto esistente.
