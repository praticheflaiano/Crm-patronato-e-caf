  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <FormPageHeader
        ...
        description="Carica un elenco di pratiche in pochi secondi. Le pratiche vengono associate ai contatti tramite il Codice Fiscale."
      />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-1">
              ...
              <strong> Codice Fiscale</strong> (del contatto), <strong>Tipo</strong>, <strong>Stato</strong> (obbligatorie),
              ed eventuale <strong>Identificativo</strong> (protocollo/numero pratica).
              Separatore virgola o punto e virgola.
            </p>
            <p className="mt-2 text-xs opacity-80">
              Nota: I contatti devono già esistere nel sistema per poter associare le pratiche.
            </p>
          </div>
        </div>
      </div>
