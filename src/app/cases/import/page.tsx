  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <FormPageHeader
        ...
        description="Carica un elenco di pratiche in pochi secondi. È necessario fornire il codice fiscale del cliente associato."
      />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-1">
              ...
              ed eventuali <strong>Stato</strong> e <strong>Descrizione</strong>. Separatore virgola o punto e virgola. Il codice fiscale deve corrispondere a un cliente esistente.
            </p>
          </div>
        </div>
      </div>
