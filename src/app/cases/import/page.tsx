  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <FormPageHeader
        ...
        description="Carica pratiche esistenti in pochi secondi."
      />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-1">
              ...
              <strong> Titolo</strong> (obbligatorio), ed eventuali <strong>Descrizione</strong>, <strong>Tipo</strong>, <strong>Stato</strong>,
              <strong> Codice Fiscale</strong> (per collegare al contatto). Separatore virgola o punto e virgola.
            </p>
          </div>
        </div>
      </div>
