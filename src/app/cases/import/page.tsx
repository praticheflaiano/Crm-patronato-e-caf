  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <FormPageHeader
        ...
        description="Carica un elenco di pratiche in pochi secondi. Le pratiche verranno associate ai contatti esistenti tramite Codice Fiscale."
      />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-2 text-xs">
              <strong>Nota:</strong> Se il Codice Fiscale non corrisponde a nessun contatto esistente, la pratica non verrà associata a nessun cliente.
            </p>
          </div>
        </div>
      </div>
