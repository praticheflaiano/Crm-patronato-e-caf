  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <FormPageHeader
        ...
        description="Carica nuove pratiche massivamente, collegandole ai clienti tramite il Codice Fiscale."
      />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-1">
              ...
              <strong> Codice Fiscale</strong>, <strong>Titolo</strong> (obbligatorie),
              ed eventuali <strong>Tipo</strong> (caf, patronato, invalidita_civile, tari),
              <strong> Stato</strong> (open, in_progress, pending_documents, completed, rejected),
              <strong> Descrizione/Note</strong>. Separatore virgola o punto e virgola. Il contatto deve già esistere.
            </p>
          </div>
        </div>
      </div>
