  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <FormPageHeader
        ...
        description="Carica un elenco di pratiche in pochi secondi. Le pratiche verranno associate ai contatti in base al Codice Fiscale fornito nel file CSV."
      />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            ...
            <p className="mt-1">
              ...
              <strong> Titolo</strong>, <strong>Codice Fiscale</strong> (del contatto, obbligatori),
              ed eventuali <strong>Tipo</strong>, <strong>Stato</strong>, <strong>Descrizione</strong>.
              <br/>Separatore virgola o punto e virgola.
            </p>
          </div>
        </div>
      </div>
