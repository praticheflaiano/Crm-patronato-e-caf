    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        ...
        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
          <Link href="/cases/import" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50"><Upload size={16} aria-hidden="true" />Importa CSV</Link>
