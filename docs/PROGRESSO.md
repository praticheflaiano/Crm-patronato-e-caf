...
2. Collegare knowledge base/RAG ufficiale per TARI e altri servizi. Completato (la Knowledge Base via PDF/Word/Testo è attiva in app/knowledge per TARI e altri).
