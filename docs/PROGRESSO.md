...
10. Import CSV e checklist sicurezza avanzata. Completato (Export/Import CSV per contatti e pratiche, checklist generata).
...
- Continuare l'integrazione di Knowledge base e RAG.
