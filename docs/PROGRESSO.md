...
10. Import CSV e checklist sicurezza avanzata. Parzialmente completato (checklist di sicurezza aggiunta).
...
3. Aggiungere import CSV (checklist sicurezza avanzata completata).
